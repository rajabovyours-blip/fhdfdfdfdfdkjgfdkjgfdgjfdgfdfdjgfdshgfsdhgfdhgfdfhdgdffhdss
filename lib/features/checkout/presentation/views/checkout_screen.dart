...
class _CheckoutScreenState extends ConsumerState<CheckoutScreen> {
  ...
  /// ocha olmaydi va xato beradi ("поставщик не найден" va h.k.). Shuning
  /// uchun tizim ilovasiga (Click/Payme) topshiramiz — u to'g'ridan-to'g'ri
  /// o'rnatilgan Click/Payme ilovasini ochadi.
  ///
  /// To'lov holati esa HECH QACHON URL orqali aniqlanmaydi — foydalanuvchi
  /// ilovaga qaytgach, backenddan haqiqiy holat so'raladi (order details
  /// ekrani buni o'zi tekshiradi).
