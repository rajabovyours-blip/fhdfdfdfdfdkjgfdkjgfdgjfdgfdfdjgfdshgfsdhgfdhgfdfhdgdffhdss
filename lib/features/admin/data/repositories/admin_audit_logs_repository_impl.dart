...
class AdminAuditLogsRepositoryImpl implements AdminAuditLogsRepository {
  final AdminAuditLogsRemoteDataSource remoteDataSource;

  AdminAuditLogsRepositoryImpl({required this.remoteDataSource});
